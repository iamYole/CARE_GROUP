...
<title>CARE GROUP | Manage Doctors</title>
  ...
  <div class="header">
   ...
   <marquee> <h1><font size="+6">CARE GROUP, MEDICAL SERVICE AT YOUR FINGER TIP</font></h1></p></marquee>
    ...
    <table width="260" align="left">
      <tr align="center">
        <td width="117" align="left"><h2><a href="AddDoctor.php"><strong>Add Doctors</strong></a></h2></td>        
      </tr>
    </table>
    <p>&nbsp;</p>
    <div id="programMenu">    
      <table width="830" border="0" align="center">
        ...
        <tr bgcolor="#E8EFF2">
          <!--<th width="109"><strong>DOCTOR ID</strong></th>-->
          <th width="119"><strong>FIRST NAME</strong></th>
          <th width="112"><strong>LAST NAME</strong></th>
          <th width="83"><strong>SEX</strong></th>
          <!--<th width="119"><strong>LOCATION</strong></th>
          <th width="113"><strong>SPECIALTY</strong></th>-->
