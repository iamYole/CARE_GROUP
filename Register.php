...
session_start();
    ...
    if (array_key_exists("PaitentID", $_SESSION))
    {        
        $isValid=false;
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST")
        {
			...
			else
			{
				...
				$db->registerUser($_POST['fn'],$_POST['ln'],$_POST['ons'],$_POST['gender'],$_POST['addy'],$_POST['mobile'],
								$_POST['mail'],$dob,$_SESSION['PaitentID']);
																
				session_start();        
				$_SESSION["User"]=$_POST['fn'].' '.$_POST['ln'];  
				//$_SESSION['ID'];//=$_SESSION['PaitentID'];      
